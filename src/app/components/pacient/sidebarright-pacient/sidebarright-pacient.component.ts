...
import { Inject, ElementRef, AfterViewInit, Renderer2, ChangeDetectionStrategy } from '@angular/core';
import { RightSidebarService } from '../../../../../src/app/core/service/rightsidebar.service';
import { MatSlideToggleChange } from '@angular/material/slide-toggle';

@Component({
  selector: 'app-sidebarright-pacient',
  templateUrl: './sidebarright-pacient.component.html',
  styleUrls: ['./sidebarright-pacient.component.sass']
})
export class SidebarrightPacientComponent implements OnInit {
