...
@Component({
  ...
  selector: 'app-sidebarright-doctor',
  templateUrl: './sidebarright-doctor.component.html',
  styleUrls: ['./sidebarright-doctor.component.sass']
})
export class SidebarrightDoctorComponent implements OnInit {
